...
export default function ProfitabilityReport({ columns, rows, sheets }: ProfitabilityReportProps) {
  ...
  const reportData = useMemo(() => {
    ...
    const totalSalesByPeriod = {
      ytd: Object.values(calculateMetrics.ytd.sales).reduce((sum: number, val) => sum + val, 0),
      lastMonth: Object.values(calculateMetrics.lastMonth.sales).reduce((sum: number, val) => sum + val, 0),
      mtd: Object.values(calculateMetrics.mtd.sales).reduce((sum: number, val) => sum + val, 0),
      thisWeek: Object.values(calculateMetrics.thisWeek.sales).reduce((sum: number, val) => sum + val, 0),
      lastWeek: Object.values(calculateMetrics.lastWeek.sales).reduce((sum: number, val) => sum + val, 0)
    }

    const totalReturnsByPeriod = {
      ytd: Object.values(calculateMetrics.ytd.returns).reduce((sum: number, val) => sum + val, 0),
      lastMonth: Object.values(calculateMetrics.lastMonth.returns).reduce((sum: number, val) => sum + val, 0),
      mtd: Object.values(calculateMetrics.mtd.returns).reduce((sum: number, val) => sum + val, 0),
      thisWeek: Object.values(calculateMetrics.thisWeek.returns).reduce((sum: number, val) => sum + val, 0),
      lastWeek: Object.values(calculateMetrics.lastWeek.returns).reduce((sum: number, val) => sum + val, 0)
    }

    const totalFeesByPeriod = {
      ytd: Object.values(calculateMetrics.ytd.fees).reduce((sum: number, val) => sum + val, 0),
      lastMonth: Object.values(calculateMetrics.lastMonth.fees).reduce((sum: number, val) => sum + val, 0),
      mtd: Object.values(calculateMetrics.mtd.fees).reduce((sum: number, val) => sum + val, 0),
      thisWeek: Object.values(calculateMetrics.thisWeek.fees).reduce((sum: number, val) => sum + val, 0),
      lastWeek: Object.values(calculateMetrics.lastWeek.fees).reduce((sum: number, val) => sum + val, 0)
    }
    ...
    const totalPurchasesByPeriod = {
      ytd: Object.values(calculateMetrics.ytd.purchases).reduce((sum: number, val) => sum + val, 0),
      lastMonth: Object.values(calculateMetrics.lastMonth.purchases).reduce((sum: number, val) => sum + val, 0),
      mtd: Object.values(calculateMetrics.mtd.purchases).reduce((sum: number, val) => sum + val, 0),
      thisWeek: Object.values(calculateMetrics.thisWeek.purchases).reduce((sum: number, val) => sum + val, 0),
      lastWeek: Object.values(calculateMetrics.lastWeek.purchases).reduce((sum: number, val) => sum + val, 0)
    }
